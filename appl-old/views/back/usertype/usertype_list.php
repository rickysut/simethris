							...
							<table id="sample-data-table" class="table">
							  <thead>
								 <tr>
									...
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
											<span class="column-title">UserType Name</span>
										</div>
									</th>
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
							  ...
							  <tbody>
								<?php $no = 1; foreach($get_all as $data){
								  // action
								  $edit = '<a href="'.base_url('usertype/update/'.$data->id_usertype).'" class="btn btn-warning"><i class="icon-chart-timeline"></i></a>';
								  $delete = '<a href="'.base_url('usertype/delete/'.$data->id_usertype).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger"><i class="icon-delete-sweep"></i></a>';
								?>
								  <tr>
