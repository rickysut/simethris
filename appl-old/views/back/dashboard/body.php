<?php $this->load->view('back/template/meta'); ?>
  ...
  <div class="content custom-scrollbar">
	<!-- Main Chart -->
	<?php 
		$bebanTanamNasional =0;$bebanProduksiNasional=0;$JmlBebanRIPH=0;
		if(empty($get_jml_riph_admin->v_beban_tanam)){$bebanTanamNasional=0;$JmlBebanRIPH=0;}else{$bebanTanamNasional=$get_jml_riph_admin->v_beban_tanam;$JmlBebanRIPH=$get_jml_riph_admin->v_beban_tanam;} 
	...
	<?php
		...
		if(empty($get_jml_rencana_tanam->luas_rencana_tanam)){$JmlrencanaTanam=0;}else{$JmlrencanaTanam=$get_jml_rencana_tanam->luas_rencana_tanam;} 
		if($JmlBebanRIPH!=0){$PersentaseCPCL = ($JmlrencanaTanam!=0)?@($JmlrencanaTanam/$JmlBebanRIPH)*100:0;}else{$PersentaseCPCL=0;}
		if($bebanTanamNasional!=0){$persentaseDonutTanam = ($JmlrencanaTanam!=0)?@($JmlrencanaTanam/$bebanTanamNasional)*100:0;}else{$persentaseDonutTanam=0;}
		if($bebanProduksiNasional!=0){$persentaseDonutProduksi = ($getjmlProduksi!=0)?@($getjmlProduksi/$bebanProduksiNasional)*100:0;}else{$persentaseDonutProduksi=0;}
 ...
 /**
	...
	var donutChart2 = {
        ...
        data: [
            {
                key: 'Realisasi',
                y  : <?php echo $DonutTanamX ?>
            },
            {
                key: 'Beban',
				y  : <?php echo $DonutTanamY ?>
            }
        ]
