				...
				<div class="col-12">
                    <div class="card">
						...
						<div class="card-body">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<?php if(pathinfo($user->file_lakhir, PATHINFO_EXTENSION)=='pdf'){
										  $pregmb = '<a href="#"><img src="'.base_url('/assets/images/pdf_thumb.png').'" height="75" onClick="ViewAttachmentPdf('."'".base_url('/uploads/file_lakhir/'.$user->file_lakhir)."'".','."'".pathinfo(base_url('/uploads/file_lakhir/'.$user->file_lakhir),PATHINFO_FILENAME)."'".');" alt="current File RIPH"></a>';
										  ...
										  $pregmb = '<a href="#"><img src="'.base_url('/uploads/file_lakhir/'.$user->file_lakhir).'" height="75" onClick="ViewAttachmentImage('."'".base_url('/uploads/file_lakhir/'.$user->file_lakhir)."'".','."'".pathinfo(base_url('/uploads/file_lakhir/'.$user->file_lakhir),PATHINFO_FILENAME)."'".');" alt="current File RIPH"></a>';
									}?>
									<p><?php echo $pregmb;?></p>
								</div>
								<div class="form-group col-md-6">
									<?php if(pathinfo($user->file_logbook, PATHINFO_EXTENSION)=='pdf'){
										  $pregmb = '<a href="#"><img src="'.base_url('/assets/images/pdf_thumb.png').'" height="75" onClick="ViewAttachmentPdf('."'".base_url('/uploads/file_logbook/'.$user->file_logbook)."'".','."'".pathinfo(base_url('/uploads/file_logbook/'.$user->file_logbook),PATHINFO_FILENAME)."'".');" alt="current File Form 5"></a>';
										  ...
										  $pregmb = '<a href="#"><img src="'.base_url('/uploads/file_logbook/'.$user->file_logbook).'" height="75" onClick="ViewAttachmentImage('."'".base_url('/uploads/file_logbook/'.$user->file_logbook)."'".','."'".pathinfo(base_url('/uploads/file_logbook/'.$user->file_logbook),PATHINFO_FILENAME)."'".');" alt="current File Form 5"></a>';
									}?>
									<p><?php echo $pregmb;?></p>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
									<input type="file" name="file_lakhir" id="file_lakhir" class="form-control" onchange="photoPreview(this,'lapreview')"/>
									<p class="help-block">File PDF/JPG/PNG</p>
									<img id="lapreview" width="auto" height="250px"/>
									<label for="file_lakhir" class="col-form-label">Laporan Akhir</label>
								</div>
								<div class="form-group col-md-6">
									<input type="file" name="file_logbook" id="file_logbook" class="form-control" onchange="photoPreview(this,'lbpreview')"/>
									<p class="help-block">File PDF/JPG/PNG</p>
									<img id="lbpreview" width="auto" height="250px"/>
									<label for="file_logbook" class="col-form-label">Log Book</label>
								</div>
							</div>
							
							<div class="form-row">
								<div class="form-group col-md-12">
									<?php if(pathinfo($user->file_sptjm, PATHINFO_EXTENSION)=='pdf'){
								...
								<div class="form-group col-md-12">
									<input type="file" name="file_sptjm" id="file_sptjm" class="form-control" onchange="photoPreview(this,'sptjmreview')"/>
									<p class="help-block">File PDF/JPG/PNG</p>
									<img id="sptjmreview" width="auto" height="250px"/>
									<label for="file_sptjm" class="col-form-label">Form SPTJM Surat Pertanggungjawaban Mutlak</label>
								</div>
							</div>
						</div>
