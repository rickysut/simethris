				...
				<div class="content container">
					<div class="row">
								...
								<div class="card-body">
									...
									<div class="form-body">
										<div class="row">
											...
											<div class="col-lg-6 col-sm-12">
												<div class="form-group">
													<label for="nama_pelaksana" class="col-form-label">Berkas Lampiran PKS</label>
													<?php if(pathinfo($user->lampiran, PATHINFO_EXTENSION)=='pdf'){
														  $pregmb = '<a href="#"><img src="'.base_url('/assets/images/pdf_thumb.png').'" height="30px" onClick="ViewAttachmentPdf('."'".base_url('/uploads/pks/'.$user->lampiran)."'".','."'".pathinfo(base_url('/uploads/pks/'.$user->lampiran),PATHINFO_FILENAME)."'".');" alt="current PKS"></a>';
													  }else if(pathinfo($user->lampiran, PATHINFO_EXTENSION)=='docx'){
														  $pregmb = '<a href="'.base_url('/uploads/pks/'.$user->lampiran).'"><img width="30px" src="'.base_url('/assets/images/docx_thumb.png').'"></a>';
													  }else if(pathinfo($user->lampiran, PATHINFO_EXTENSION)=='xlsx'){
														  $pregmb = '<a href="'.base_url('/uploads/pks/'.$user->lampiran).'"><img width="30px" src="'.base_url('/assets/images/excel_thumb.png').'"></a>';
													  }else{
														  $pregmb = '<a href="#"><img src="'.base_url('/uploads/pks/'.$user->lampiran).'" height="30px" onClick="ViewAttachmentImage('."'".base_url('/uploads/pks/'.$user->lampiran)."'".','."'".pathinfo(base_url('/uploads/pks/'.$user->lampiran),PATHINFO_FILENAME)."'".');" alt="current PKS"></a>';
													}?>
													<p><?php echo $pregmb;?></p>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-lg-4 col-sm-12">
												<div class="form-group">
													<label for="name" class="control-label">Pola Pelaksanaan</label>
													<?php echo form_dropdown('', $type_pelaksana_value, $user->type_pelaksana, $type_pelaksana) ?>
												</div>
												<div class="form-group">
													<label for="nama_pelaksana" class="control-label">Pengelola</label>
													<?php echo form_input($nama_pelaksana,$user->nama_pelaksana) ?>
												</div>
											</div>
											<div class="col-lg-4 col-sm-12">
												<div class="form-group">
													<label for="tgl_awal_perjanjian" class="control-label">Tgl Awal Perjanjian</label>
													<?php echo form_input($tgl_awal_perjanjian,$user->tgl_awal_perjanjian) ?>
												</div>
												<div class="form-group">
													<label for="tgl_akhir_perjanjian" class="control-label">Tgl Akhir Perjanjian</label>
													<?php echo form_input($tgl_akhir_perjanjian,$user->tgl_akhir_perjanjian) ?>
												</div>
											</div>
											<div class="col-lg-4 col-sm-12">
												<div class="form-group">
													<label for="luas_rencana_tanam" class="control-label">Rencana Luas Tanam <sup>(ha)</sup></label>
													<?php echo form_input($luas_rencana_tanam,$user->luas_rencana_tanam) ?>
												</div>
												<div class="form-group">
													<label for="rencana_produksi" class="control-label">Rencana Produksi <sup>(ton)</sup></label>
						...
						<div class="col-12" >
							<div class="card">
								<div class="card-header">
									<h5>PETUGAS & LOKASI TANAM</h5>
								</div>
								<div class="card-body">
									<div class="alert alert-danger"><small><i>Data Petugas/Petani Pengelola Lahan Wajib Tanam. Untuk Kelompok Tani, daftarkan nama-nama petani terlebih dahulu di menu Poktan. <b>Dev Note: mohon agar tabel petugas pelaksana dan lokasi dapat dihubungkan.</b></i></small></div>
									<div class="card card-body form-body">
										<h4 class="card-titles text-info font-bold">Lokasi Perjanjian</h4>
										<div class="row">
											...
											<div class="col-lg-3 col-sm-12">
												<div class="form-group">													
													...
													?>
													<label for="name" class="col-form-label">Kab/Kota</label>
													<select name="kabupaten" class="bg-white form-control" id="kabupaten" onchange="setpetakota(this.options[this.selectedIndex].value)" disabled>
											...
											<div class="col-lg-3 col-sm-12">
												<div class="form-group">
													...
													<select name="kecamatan" class="bg-white form-control" id="kecamatan" disabled>
											...
											<div class="col-lg-3 col-sm-12">
												<div class="form-group">
													...
													<select name="desa" class="bg-white form-control" id="desa" disabled>
									...
									<div class="card card-body form-body">
										<h4 class="card-titles text-info font-bold">Petugas Pengelola & Lokasi Tanam</h4>
										<div class="row">
											Tabel Petugas Pengelola & Lokasi Tanam
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-12" hidden>
							<div class="card">
								...
								<div class="card-body">
									...
									<ul class="nav nav-tabs m-t-15" id="myTab" role="tablist">
										<li class="nav-item">
								...
								<div class="card-footer">
									<div class="btn-group" role="group" aria-label="Default button group">
										<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#verifikasiModal" data-whatever="@getbootstrap">Verifikasi
										</button>
									</div>
								</div>
							</div>
						...
						<div class="col-12" >
							<div class="card card-footer">
								<div class="btn-group" role="group" aria-label="Default button group">
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#verifikasiModal" data-whatever="@getbootstrap">Verifikasi</button>
								</div>
							</div>
						</div>
