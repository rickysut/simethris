  ...
  <div class="content custom-scrollbar">
    ...
    <div class="doc data-table-doc page-layout simple full-width">
		<div class="page-header bg-primary text-auto p-6 row no-gutters align-items-center justify-content-between">
            <h1 class="doc-title h4" id="content">Daftar Menu Akses</h1>
							...
							<table id="sample-data-table" class="table">
							  <thead>
								 <tr>
									...
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
											<span class="column-title">SubMenu</span>
										</div>
									</th>
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
							  ...
							  <tbody>
								<?php $no = 1; foreach($get_all as $menu_access){
								  // action
								  $edit = '<a href="'.base_url('menuaccess/update/'.$menu_access->id_menu_access).'" class="btn btn-xm btn-warning"><i class="icon-chart-timeline"></i></a>';
								  $delete = '<a href="'.base_url('menuaccess/delete/'.$menu_access->id_menu_access).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-xm btn-danger"><i class="icon-delete-sweep"></i></a>';
								?>
								  <tr>
									<td style="text-align: center"><?php echo $no++ ?></td>
									<td style="text-align: left"><?php echo $menu_access->usertype_name ?></td>
									<td style="text-align: left"><?php echo $menu_access->menu_name ?></td>
									<td style="text-align: left"><?php echo $menu_access->submenu_name ?></td>
