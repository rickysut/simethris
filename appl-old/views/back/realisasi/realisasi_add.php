...
<div class="content-wrapper">
  ...
  <div class="doc forms-doc page-layout simple full-width">
    ...
    <div class="page-header bg-primary text-auto p-6 row no-gutters align-items-center justify-content-between">
        <h1 class="doc-title h4" id="content"><?php echo $page_title ?> PKS NO:  <?php echo $user->no_pks ?></h1>
						...
						<div class="card-header">
							<div class="description">
								<div class="description-text">
									<h5>DATA PETANI / PELAKSANA - POKTAN : <?php echo $user->nama_pelaksana ?></h5>
								</div>
							</div>
						</div>
						<div class="card-body">
								 ...
								 <tr>
									...
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
											<span class="column-title">ID Lokasi</span>
										</div>
									</th>
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
									...
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
											<span class="column-title">Tanggal Tanam</span>
										</div>
									</th>
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
											<span class="column-title">Luas Tanam</span>
										</div>
									</th>
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
											<span class="column-title">Latitude</span>
										</div>
									</th>
									<th style="text-align: center" class="secondary-text">
										<div class="table-header">
											<span class="column-title">Longitude</span>
										</div>
									</th>
								</tr>
							</thead>
                    ...
                    <div class="card">
						...
						<div class="card-body">
							<div class="form-row">
								...
								<label class="control-label col-md-3">Kelompok Tani</label>
								<div class="col-md-3">
									<?php echo form_input($nama_pelaksana, $user->nama_pelaksana) ?>
									<span class="help-block"></span>
								</div>
								<?php echo form_input($nama_petugas) ?>
							</div>
							<div class="form-row">
								<label class="control-label col-md-3">Tanggal Rencana Tanam</label>
								<div class="col-md-3">
									<?php echo form_input($tgl_rencana_tanam) ?>
									<span class="help-block"></span>
								</div>
								<label class="control-label col-md-3">Tanggal Realisasi Tanam</label>
								<div class="col-md-3">
							...
							<div class="form-row">
								<label class="control-label col-md-3">Rencana Luas Tanam</label>
								<div class="col-md-3">
									<?php echo form_input($luas_rencana_tanam) ?>
									<span class="help-block"></span>
								</div>
								<label class="control-label col-md-3">Luas Realisasi Tanam</label>
								<div class="col-md-3">
...
<?php $this->load->view('back/template/footer'); ?>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/') ?>datatables/DataTables-1.10.21/css/jquery.dataTables.min.css">
  ...
  <script src="https://maps.googleapis.com/maps/api/js?libraries=geometry,drawing&key=AIzaSyA-5NYrzuZRWLJXXak3lsRht1K8xJNRI3w"></script>
   <!-- <script src="https://maps.google.com/maps/api/js?v=3.40&libraries=geometry,places,drawing&key=AIzaSyCmByxQYKyC_hhkkoSFCiWM_0TwQjGckLs"></script> -->
...
<script >
	...
	function setpetakota(lokasi) {
	  ...
	  var id = koordinat[0];
	  if(isNaN(x) || isNaN(y)){
		  alert('Titik Koordinat Tidak Lengkap, Silahkan isi di Rencana Tanam');
	  }
	...
	google.maps.event.addDomListener(window, 'load', setpetakota(lokasi));
    </script>
	<script>
...
<script>
    ...
    $(document).ready(function(){
		table = $('#table').DataTable({ 
			...
			"ajax": {
				"url": "<?php echo site_url('realisasi/ajax_list/').$user->id_cpcl; ?>",
				"type": "POST",
				"cache":false,
			},
			"columnDefs": [{
        ...
        .on( 'select', function ( e, dt, type, indexes ) {
			...
			var lokasiku = table.rows({ selected: true }).data()[0][3]+"|"+table.rows({ selected: true }).data()[0][8]+"|"+table.rows({ selected: true }).data()[0][9];
			setpetakota(lokasiku);
			document.getElementById('nama_petugas').value = table.rows({ selected: true }).data()[0][4];
            document.getElementById('address').value = table.rows({ selected: true }).data()[0][5];
			document.getElementById('tgl_rencana_tanam').value = table.rows({ selected: true }).data()[0][6];
			document.getElementById('luas_rencana_tanam').value = table.rows({ selected: true }).data()[0][7];
        })
