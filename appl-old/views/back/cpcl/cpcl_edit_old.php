                ...
                <form action="#" id="form_peta" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <input name="atitude" placeholder="" class="form-control" type="text" required readonly>
                                <span class="help-block"></span>
                            </div>
							<label class="control-label col-md-3">Longitude</label>
                            <div class="col-md-3">
                                <input name="latitude" placeholder="" class="form-control" type="text" required readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>
						<div class="col-12">
