						...
						<div class="card-header">
							<div class="row no-gutters align-items-center justify-content-between">
								...
								<div class="btn-group" role="group" aria-label="saprodi">
										<a class="btn btn-primary fuse-ripple-ready" href="javascript:void(0)" id="tombolTambahSaprodi" title="Isi / Tambah Saprodi" onclick="add_saprodi()"><i class="fa fa-plus"></i> Tambah Saprodi</a>
                    ...
                    <div class="card">
						<div class="card-header">
							...
							<div class="btn-group" role="group" aria-label="daftar-petani">
									<a class="btn btn-primary fuse-ripple-ready" href="javascript:void(0)" id="tombolTambahpetani" data-toggle="tooltip" title="Tambah Petugas/Petani" onclick="add_person()"><i class="fa fa-users"></i> Petugas/Petani Pengelola</a>
...
<div class="modal fade" id="modal_form_peta" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" name="btnSavep" onclick="savePeta()" class="btn btn-primary">Simpan</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal fade" id="modal_form_petani2" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave2" onclick="save2()" class="btn btn-primary">Tambahkan</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal fade" id="modal_form_saprodi" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" name="btnSaveProdi" class="btn btn-primary">Tambahkan</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
