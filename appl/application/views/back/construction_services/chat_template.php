                                                ...
                                                <?php if(!empty($vendorslist)){
                                                    ...
                                                    <div <?php echo $gaya ?> id="<?=$v['id_users'];?>" title="<?=$v['name'];?>" src="<?=$v['photo'];?>">
                                                        ...
                                                        <div class="col-12 col-sm-auto d-flex flex-column align-items-end">
                                                            ...
                                                            <div <?php echo $tpesan ?>><?php if ($jmlpesan > 0) { echo $tglpesan; }; ?></div>

                                                            <div  <?php echo $uread ?>><?php if ($jmlpesan > 0) { echo $jmlpesan; }; ?></div>
...
$('.selectVendor').click(function(){
	  ...
	  /*$('#lastmsgtime').removeClass('last-message-time');
      $('#lastmsgtime').html('');
      $('#msgcount').removeClass('bg-secondary');
      $('#msgcount').removeClass('text-auto');
      $('#msgcount').removeClass('unread-message-count');
      $('#msgcount').removeClass('mt-2');
      $('#msgcount').html('');
