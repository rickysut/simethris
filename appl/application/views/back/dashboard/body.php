...
<div class="content-wrapper">
	...
	<div class="content custom-scrollbar">
		<!-- Main Chart -->
		<?php
		$bebanTanamNasional = 0;
		$bebanProduksiNasional = 0;
		$JmlBebanRIPH = 0;
		if (empty($get_jml_riph_admin->v_beban_tanam)) {
			$bebanTanamNasional = 0;
			$JmlBebanRIPH = 0;
		} else {
			$bebanTanamNasional = $get_jml_riph_admin->v_beban_tanam;
			$JmlBebanRIPH = $get_jml_riph_admin->v_beban_tanam;
		}
		if (empty($get_jml_riph_admin->v_beban_produksi)) {
			$bebanProduksiNasional = 0;
		} else {
			$bebanProduksiNasional = $get_jml_riph_admin->v_beban_produksi;
		}
		$chartRW = array();
		$jmlR = array();
		$jmlverif = 0;
		...
		$jmlchartPKSw3 = 0;
		$jmlchartrealisasi = 0;
		$jmlchartrealisasiw1 = 0;
		$jmlchartrealisasiw2 = 0;
		$jmlchartrealisasiw3 = 0;
		$jmlchartproduksi = 0;
		$jmlchartproduksiw1 = 0;
		$jmlchartproduksiw2 = 0;
		$jmlchartproduksiw3 = 0;
		$jmlbrealisasi = 0;
		$jmlbrealisasiw1 = 0;
		$jmlbrealisasiw2 = 0;
		$jmlbrealisasiw3 = 0;
		...
		$hari[6] = "Sab";
		$hari[7] = "Min";
		foreach ($get_chart_verifikasi as $getVerif) {
			if (is_null($getVerif->jumlah_verif)) {
				$jmlverif = 0;
			} else {
				$jmlverif = $getVerif->jumlah_verif;
			}
		}
		foreach ($get_chart_unverifikasi as $getunVerif) {
			if (is_null($getunVerif->jumlah_unverif)) {
				$jmlunverif = 0;
			} else {
				$jmlunverif = $getunVerif->jumlah_unverif;
			}
		}
		foreach ($get_chart_verifikasi_w1 as $getVerifw1) {
			if (is_null($getVerifw1->jumlah_verif)) {
				$jmlverifw1 = 0;
			} else {
				$jmlverifw1 = $getVerifw1->jumlah_verif;
			}
		}
		foreach ($get_chart_unverifikasi_w1 as $getunVerifw1) {
			if (is_null($getunVerifw1->jumlah_unverif)) {
				$jmlunverifw1 = 0;
			} else {
				$jmlunverifw1 = $getunVerifw1->jumlah_unverif;
			}
		}
		foreach ($get_chart_verifikasi_w2 as $getVerifw2) {
			if (is_null($getVerifw2->jumlah_verif)) {
				$jmlverifw2 = 0;
			} else {
				$jmlverifw2 = $getVerifw2->jumlah_verif;
			}
		}
		foreach ($get_chart_unverifikasi_w2 as $getunVerifw2) {
			if (is_null($getunVerifw2->jumlah_unverif)) {
				$jmlunverifw2 = 0;
			} else {
				$jmlunverifw2 = $getunVerifw2->jumlah_unverif;
			}
		}
		foreach ($get_chart_verifikasi_w3 as $getVerifw3) {
			if (is_null($getVerifw3->jumlah_verif)) {
				$jmlverifw3 = 0;
			} else {
				$jmlverifw3 = $getVerifw3->jumlah_verif;
			}
		}
		foreach ($get_chart_unverifikasi_w3 as $getunVerifw3) {
			if (is_null($getunVerifw3->jumlah_unverif)) {
				$jmlunverifw3 = 0;
			} else {
				$jmlunverifw3 = $getunVerifw3->jumlah_unverif;
			}
		}
		$jmlchartPKSw3 = $jmlverifw3 + $jmlunverifw3;
		$jmlchartPKSw2 = $jmlverifw2 + $jmlunverifw2;
		$jmlchartPKSw1 = $jmlverifw1 + $jmlunverifw1;
		$jmlchartPKS = $jmlverif + $jmlunverif;
		foreach ($get_chart_beban as $getchartbeban) {
			if (is_null($getchartbeban->bebantanam)) {
				$jmlbrealisasi = 0;
			} else {
				$jmlbrealisasi = $getchartbeban->bebantanam;
			}
			if (is_null($getchartbeban->bebanproduksi)) {
				$jmlbproduksi = 0;
			} else {
				$jmlbproduksi = $getchartbeban->bebanproduksi;
			}
		}
		foreach ($get_chart_beban_w1 as $getchartbebanw1) {
			if (is_null($getchartbebanw1->bebantanam)) {
				$jmlbrealisasiw1 = 0;
			} else {
				$jmlbrealisasiw1 = $getchartbebanw1->bebantanam;
			}
			if (is_null($getchartbebanw1->bebanproduksi)) {
				$jmlbproduksiw1 = 0;
			} else {
				$jmlbproduksiw1 = $getchartbebanw1->bebanproduksi;
			}
		}
		foreach ($get_chart_beban_w2 as $getchartbebanw2) {
			if (is_null($getchartbebanw2->bebantanam)) {
				$jmlbrealisasiw2 = 0;
			} else {
				$jmlbrealisasiw2 = $getchartbebanw2->bebantanam;
			}
			if (is_null($getchartbebanw2->bebanproduksi)) {
				$jmlbproduksiw2 = 0;
			} else {
				$jmlbproduksiw2 = $getchartbebanw2->bebanproduksi;
			}
		}
		foreach ($get_chart_beban_w3 as $getchartbebanw3) {
			if (is_null($getchartbebanw3->bebantanam)) {
				$jmlbrealisasiw3 = 0;
			} else {
				$jmlbrealisasiw3 = $getchartbebanw3->bebantanam;
			}
			if (is_null($getchartbebanw3->bebanproduksi)) {
				$jmlbproduksiw3 = 0;
			} else {
				$jmlbproduksiw3 = $getchartbebanw3->bebanproduksi;
			}
		}
		foreach ($get_chart_jmlrealisasi as $getchartrealisasi) {
			if (is_null($getchartrealisasi->jumlah_realisasi)) {
				$jmlchartrealisasi = 0;
			} else {
				$jmlchartrealisasi = $getchartrealisasi->jumlah_realisasi;
			}
		}
		foreach ($get_chart_jmlrealisasi_w1 as $getchartrealisasiw1) {
			if (is_null($getchartrealisasiw1->jumlah_realisasi)) {
				$jmlchartrealisasiw1 = 0;
			} else {
				$jmlchartrealisasiw1 = $getchartrealisasiw1->jumlah_realisasi;
			}
		}
		foreach ($get_chart_jmlrealisasi_w2 as $getchartrealisasiw2) {
			if (is_null($getchartrealisasiw2->jumlah_realisasi)) {
				$jmlchartrealisasiw2 = 0;
			} else {
				$jmlchartrealisasiw2 = $getchartrealisasiw2->jumlah_realisasi;
			}
		}
		foreach ($get_chart_jmlrealisasi_w3 as $getchartrealisasiw3) {
			if (is_null($getchartrealisasiw3->jumlah_realisasi)) {
				$jmlchartrealisasiw3 = 0;
			} else {
				$jmlchartrealisasiw3 = $getchartrealisasiw3->jumlah_realisasi;
			}
		}
		foreach ($get_chart_jmlproduksi as $getchartproduksi) {
			if (is_null($getchartproduksi->jumlah_produksi)) {
				$jmlchartproduksi = 0;
			} else {
				$jmlchartproduksi = $getchartproduksi->jumlah_produksi;
			}
		}
		foreach ($get_chart_jmlproduksi_w1 as $getchartproduksiw1) {
			if (is_null($getchartproduksiw1->jumlah_produksi)) {
				$jmlchartproduksiw1 = 0;
			} else {
				$jmlchartproduksiw1 = $getchartproduksiw1->jumlah_produksi;
			}
		}
		foreach ($get_chart_jmlproduksi_w2 as $getchartproduksiw2) {
			if (is_null($getchartproduksiw2->jumlah_produksi)) {
				$jmlchartproduksiw2 = 0;
			} else {
				$jmlchartproduksiw2 = $getchartproduksiw2->jumlah_produksi;
			}
		}
		foreach ($get_chart_jmlproduksi_w3 as $getchartproduksiw3) {
			if (is_null($getchartproduksiw3->jumlah_produksi)) {
				$jmlchartproduksiw3 = 0;
			} else {
				$jmlchartproduksiw3 = $getchartproduksiw3->jumlah_produksi;
			}
		}
		...
		$bulan = array();
		$jmlpro = array();
		foreach ($get_jml_produksi as $jml_produksi) {
		...
		if ($get_jml_cpcl_verifikasi->jml_verifikasi != 0) {
		...
		if ($bttanam != 0) {
			$bpersen = ($bltanam != 0) ? ($bltanam / ($bttanam+$bltanam)) * 100 : 0;
		} else {
			$bpersen = 0;
		}
		...
		if ($get_jml_realisasi_verifikasi->jml_verifikasi != 0) {
		...
		if ($get_jml_produksi_verifikasi->jml_verifikasi != 0) {
		...
		if (empty($get_jml_rencana_tanam->luas_rencana_tanam)) {
			$JmlrencanaTanam = 0;
		} else {
			$JmlrencanaTanam = $get_jml_rencana_tanam->luas_rencana_tanam;
		}//12489.3
		...
		if ($bebanTanamNasional != 0) {
			$persentaseDonutTanam = ($getRealTanam != 0) ? @($getRealTanam / $bebanTanamNasional) * 100 : 0;
		} else {
			$persentaseDonutTanam = 0;
		}
		if ($bebanProduksiNasional != 0) {
			$persentaseDonutProduksi = ($getjmlProduksi != 0) ? @($getjmlProduksi / $bebanProduksiNasional) * 100 : 0;
		} else {
			$persentaseDonutProduksi = 0;
		}
		//var_dump($persentaseDonutTanam, $persentaseDonutProduksi);

		$DonutTanamX 		= $JmlrencanaTanam;
		$DonutTanamY 		= $bebanTanamNasional - $JmlrencanaTanam;
		$DonutProduksiX 	= $getjmlProduksi;
		$DonutProduksiY 	= $bebanProduksiNasional - $getjmlProduksi;
		$DonutRencanaX 		= $JmlrencanaTanam;
		//$DonutRencanaY 		= $JmlBebanRIPH - $JmlrencanaTanam;
		$DonutRencanaY 		= $JmlBebanRIPH;
		//var_dump($DonutRencanaX, $DonutRencanaY);
...
.progress{
    ...
    border: none;
		...
		<div id="project-dashboard" class="doc data-table-doc page-layout simple full-width">
			...
			<!--div class="page-content-wrapper custom-scrollbar"-->
				...
				<!--div class="page-header bg-primary text-auto d-flex flex-column justify-content-between px-6 pt-4 pb-0"-->
					<h1 class="doc-title h4" id="content">Welcome back, <?php echo $this->session->name ?>!</h1>
									...
									<div class="widget widget4 card">
										...
										<div class="widget-content pt-2 pb-8 d-flex flex-column align-items-center justify-content-center">
											<!--span class="text-muted"><?php if (empty($get_jml_riph_admin->tanggal)) {
																			...
																			echo date('d-m-Y h:i:sa', strtotime($get_jml_riph_admin->tanggal));
																		} ?></span-->
											<div class="sub-title h3 text-danger"><?php if (empty($get_jml_riph_admin->jml_importir)) {
																						echo '0';
																					} else {
																						echo number_format($get_jml_riph_admin->jml_importir, 0, ".", ".");
																					} ?><span><sup style="font-size: 10px"> Perusahaan</sup></span></div>


										</div>
										<div class="widget-footer p-1 bg-light row no-gutters align-items-center">
											<span class="text-muted">Dilaporkan :</span>
									...
									<div class="widget widget1 card">
										...
										<div class="widget-content pt-2 pb-8 d-flex flex-column align-items-center justify-content-center">
											...
											<div class="sub-title h3 text-secondary"><?php if (empty($get_jml_riph_admin->v_pengajuan_import)) {
																							...
																							echo number_format($get_jml_riph_admin->v_pengajuan_import, 0, ".", ".");
																						} ?><span><sup style="font-size: 10px"> Ton</sup></span></div>
										</div>
										<div class="widget-footer p-1 bg-light row no-gutters align-items-center">
											<span class="text-muted">Dilaporkan : </span>
											<span class="h5"> <?php if (empty($get_jml_import->vimport)) {
																	...
																	echo number_format($get_jml_import->vimport, 0, ".", ".");
																} ?><span><sup style="font-size: 10px"> Ton</sup></span></span>
										</div>
									</div>
								</div>
								<!-- / WIDGET 1 -->
									...
									<div class="widget widget2 card">
										...
										<div class="widget-content pt-2 pb-8 d-flex flex-column align-items-center justify-content-center">
											...
											<div class="sub-title h3 text-danger"><?php if (empty($get_jml_riph_admin->v_beban_tanam)) {
																						...
																						echo number_format($get_jml_riph_admin->v_beban_tanam, 0, ".", ".");
																					} ?><span><sup style="font-size: 10px"> Ton</sup></span></div>
										...
										<div class="widget-footer p-1 bg-light row no-gutters align-items-center">
											...
											<span class="h5"> <?php if (empty($get_jml_real_tanam->jmlluas)) {
																	...
																	echo number_format($get_jml_real_tanam->jmlluas, 0, ".", ".");
																} ?><span><sup style="font-size: 10px"> Ha</sup></span></span>
										</div>
									</div>
								</div>
								<!-- / WIDGET 2 -->
									...
									<div class="widget widget3 card">
										...
										<div class="widget-content pt-2 pb-8 d-flex flex-column align-items-center justify-content-center">
											...
											<div class="sub-title h3 text-danger"><?php if (empty($get_jml_riph_admin->v_beban_produksi)) {
																						...
																						echo number_format($get_jml_riph_admin->v_beban_produksi, 0, ".", ".");
																					} ?><span><sup style="font-size: 10px"> Ton</sup></span></div>
										...
										<div class="widget-footer p-1 bg-light row no-gutters align-items-center">
											...
											<span class="h5"> <?php if (empty($get_jml_all_produksi->jmlproduksi)) {
																	...
																	echo number_format($get_jml_all_produksi->jmlproduksi, 0, ".", ".");
																} ?><span><sup style="font-size: 10px"> Ton</sup></span></span>
										</div>
													...
													<table id="dataTable" class="table table-striped dt-responsive display nowrap" style="width:100%">
														<thead>
															<tr>
																...
																<th style="text-align: center;background-color:#03a9f4;vertical-align:middle">
																	<font color="white">NO
																</th>
																<th style="text-align: center;background-color:#03a9f4;vertical-align:middle">
																	<font color="white">Nama Perusahaan
																</th>
																<th style="text-align: center;background-color:#03a9f4;vertical-align:middle">
																	<font color="white">Nomor RIPH
																</th>
																<th style="text-align: center;background-color:#03a9f4">
																	<font color="white">Tahap 1 <br><sup style="font-size: 10px">(Renc. Tanam)</sup>
																</th>
																<th style="text-align: center;background-color:#03a9f4">
																	<font color="white">Tahap 2 <br><sup style="font-size: 10px">(Verif Tanam)</sup>
																</th>
																<th style="text-align: center;background-color:#03a9f4">
																	<font color="white">Tahap 3 <br><sup style="font-size: 10px">(verif Produksi)</sup>
																</th>
																<th style="text-align: center;background-color:#03a9f4">
																	<font color="white">Tahap 4 <br><sup style="font-size: 10px">(Ket. Lunas)</sup>
																</th>
																<th style="text-align: center;background-color:#03a9f4">
																	<font color="white">Tahapan <br><sup style="font-size: 10px">Status</sup>
																</th>
															</tr>
														</thead>
														<tbody>
															...
															$persentaseLangkah = 0;
															$langkah = 0;
															foreach ($get_all_table_steps as $user) {
															?>
																<tr>
																	...
																	$persentaseVerif = ($diterimapks != 0) ? round(($diterimapks / $allpks) * 100,2) : 0;
																	$langkah = $persentaseVerif;
																	?>
																	<td>
																		<div class="progress" style="height: 15px;">
																			<div class="progress-bar bg-success" role="progressbar" aria-valuenow="<?php echo $persentaseVerif; ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $persentaseVerif; ?>%">
																			<?php if ($persentaseVerif > 0) { ?>
																				<span><?php echo $persentaseVerif; ?>%</span>
																			<?php }; ?>
																			</div>
																		</div>
																	</td>
																	<?php $diterimarealisasi = 0;
																	$allrealisasi = 0;
																	$query = $this->db->get_where('cpcl', array('id_mst_riph' => $user->id_mst_riph));
																	...
																	$persentaseVRealisasi = ($diterimarealisasi != 0) ? round(($diterimarealisasi / $allrealisasi) * 100,2) : 0;
																	$langkah += $persentaseVRealisasi;
																	?>
																	<td>
																		<div class="progress" style="height: 15px;">
																			<div class="progress-bar bg-success" role="progressbar" aria-valuenow="<?php echo $persentaseVRealisasi; ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $persentaseVRealisasi; ?>%">
																			<?php if ($persentaseVRealisasi > 0) { ?>
																	...
																	$persentaseVProduksi = ($diterimaproduksi != 0) ? round(($diterimaproduksi / $allproduksi) * 100,2) : 0;
																	$langkah += $persentaseVProduksi;
																	?>
																	<td>
																		<div class="progress" style="height: 15px;">
																			<div class="progress-bar bg-success" role="progressbar" aria-valuenow="<?php echo $persentaseVProduksi; ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $persentaseVProduksi; ?>%">
																			<?php if ($persentaseVProduksi > 0) { ?>
																				<span><?php echo $persentaseVProduksi; ?>%</span>
																			<?php }; ?>
																			</div>
																		</div>
																	</td>
																	<?php $persentaseLangkah = ($langkah != 0) ? round(($langkah / 300) * 100,2) : 0;
																	?>
																	<td>
																		<div class="progress" style="height: 15px;">
																			<div class="progress-bar bg-success" role="progressbar" aria-valuenow="<?php echo $persentaseLangkah; ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $persentaseLangkah; ?>%">
																			<?php if ($persentaseLangkah > 0) { ?>
									...
									<div class="widget widget10 card">
										...
										<div class="widget-content p-3">
											...
											<table id="table-data" class="table">
												...
												<tbody>
													<?php $no = 1;
													foreach ($rekapdataPerusahaan as $user) {
								...
								<div class="col-12">
									...
									<div class="card">
										...
										<div class="widget-header px-4 py-6 row no-gutters align-items-center justify-content-between">
											...
											<div>
												<span class="badge badge-danger"><?php $jmlUser = count($get_all_lo);
																					echo $jmlUser ?> members</span>
											</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#date-dropdown").change(function(){
			var thn = $(this).val();
			window.location = "<?php echo site_url('dashboard'); ?>/" + thn;
		});
		$("#bln").change(function() {
...
<script>
	...
	var donutChart2 = {
		...
		data: [{
			...
			{
				key: 'Sisa Beban',
				y: <?php echo $DonutRencanaY-$getRealTanam ?>
			}
		]
	...
	var donutChart3 = {
		...
		data: [{
				key: 'Produksi',
				y: <?php echo $DonutProduksiX ?>
			},
			{
				key: 'Sisa Beban',
				y: <?php echo $DonutProduksiY ?>
			}
		]
	...
	var donutChart4 = {
		...
		data: [{
				key: 'Rencana ' ,
				y: <?php echo $DonutRencanaX ?>
			},
			{
				key: 'Sisa Beban ',
				y: <?php echo $DonutRencanaY-$DonutRencanaX ?>
	...
	nv.addGraph(function() {
		...
		function centerText() {
			return function() {
				...
				donut.insert("text", "g")
					.text("<?php echo number_format((float)$bpersen, 2, '.', '')  ?> %")
					.attr("class", "middle")
		...
		function centerText2() {
			return function() {
				...
				donut2.insert("text", "g")
					.text("<?php echo number_format((float)$persentaseDonutTanam, 2, '.', '')   ?> %")
					.attr("class", "middle")
					.attr("text-anchor", "middle")
					.attr("dy", "0em")
					.style("fill", "#000");
		...
		function centerText3() {
			return function() {
				...
				donut3.insert("text", "g")
					.text("<?php echo number_format((float)$persentaseDonutProduksi, 2, '.', '')  ?> %")
					.attr("class", "middle")
					.attr("text-anchor", "middle")
					.attr("dy", "0em")
					.style("fill", "#000");
		...
		function centerText4() {
			return function() {
				...
				donut4.insert("text", "g")
					.text("<?php echo number_format((float)$PersentaseCPCL, 2, '.', '')  ?> %")
					.attr("class", "middle")
					.attr("text-anchor", "middle")
					.attr("dy", "0em")
					.style("fill", "#000");
