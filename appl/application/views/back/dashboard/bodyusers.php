                                        ...
                                        <div class="widget-content pt-2 pb-8 d-flex flex-column align-items-center justify-content-center">
                                            ...
                                            <div id="donut-chart2">
                                                ...
                                                <div style="text-align:center"><span class="text-muted">Realisasi Tanam : </span>
                                                    <span class="ml-2"><?php echo $getRealTanam ?> Ha</span>
                                                </div>
                                                <div style="text-align:center"><span class="text-muted">Beban Tanam : </span>
                                                    <span class="ml-2"><?php echo $getBebanTanam ?> Ha</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="widget-content pt-2 pb-8 d-flex flex-column align-items-center justify-content-center">
                                            ...
                                            <div id="donut-chart3">
                                                ...
                                                <div style="text-align:center"><span class="text-muted">Realisasi Produksi : </span>
                                                    <span class="ml-2"><?php echo $getjmlProduksi ?> Ton</span>
                                                </div>
                                                <div style="text-align:center"><span class="text-muted">Beban Produksi : </span>
                                                    <span class="ml-2"><?php echo $getjmlBebanProduksi ?> Ton</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <table id="dataTable" class="table table-striped table-bordered dt-responsive">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="text-align: center;background-color:#03a9f4;vertical-align:middle">
                                                                    <font color="white">No. RIPH
                                                                </th>
                                                                <th style="text-align: center;background-color:#03a9f4">
                                                                    <font color="white">Tahap 1 <br><sup style="font-size: 10px">(Pengajuan)</sup>
                                                                </th>
                                                                <th style="text-align: center;background-color:#03a9f4">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <?php if ($user->ststahap1 == '1') {
                                                                        $gaya1 = 'style="text-align: center;background-color:forestgreen"';
                                                                        $myicon = '<i class="icon icon-check-circle-outline"></i>';
                                                                        $tahap = 1;
                                                                        $statusna = true;
                                                                    } else if ($user->ststahap1 == '2') {
                                                                        $gaya1 = 'style="text-align: center;background-color:darkorange"';
                                                                        $myicon = '<i class="icon icon-triangle-outline"></i>';
                                                                        $tahap = 1;
                                                                        $statusna = false;
                                                                    } else if ($user->ststahap1 == '3') {
                                                                        $gaya1 = 'style="text-align: center;background-color:red"';
                                                                        $myicon = '<i class="icon-close-circle-outline"></i>';
                                                                        $tahap = 1;
                                                                        $statusna = false;
                                                                    } else if ($user->ststahap1 == '0') {
                                                                        $gaya1 = 'style="text-align: center;background-color:#03A9F4"';
                                                                        $myicon = '<i class="icon icon-timer-sand"></i>';
                                                                        $tahap = 1;
                                                                        $statusna = false;
                                                                    } else {
                                                                        $gaya1 = 'style="text-align: center;background-color:white"';
                                                                        $myicon = '<i class=""></i>';
                                                                        $tahap = 1;
                                                                        $statusna = false;
                                                                    }
                                                                    ?>
                                                                    <td <?php echo $gaya1 ?>>
                                                                        <font color="white"><?php if (!is_null($user->tgl_aju_verif_th1)) {
                                                                                                echo $myicon . ' ' . date("d-m-Y", strtotime($user->tgl_aju_verif_th1));
                                                                                            } ?><br><sup style="font-size: 10px"><?php if (!is_null($user->tgl_aju_verif_th1)) {
                                                                                                                                                                                                                                                        echo date("H:i:s", strtotime($user->tgl_aju_verif_th1));
                                                                                                                                                                                                                                                    } ?></sup>
                                                                    </td>
                                                                    <?php if ($user->ststahap2 == '1') {
                                                                        $gaya2 = 'style="text-align: center;background-color:forestgreen"';
                                                                        $myicon = '<i class="icon icon-check-circle-outline"></i>';
                                                                        $tahap = 2;
                                                                        $statusna = true;
                                                                    } else if ($user->ststahap2 == '2') {
                                                                        $gaya2 = 'style="text-align: center;background-color:darkorange"';
                                                                        $myicon = '<i class="icon icon-triangle-outline"></i>';
                                                                        $tahap = 1;
                                                                        $statusna = false;
                                                                    } else if ($user->ststahap2 == '3') {
                                                                        $gaya2 = 'style="text-align: center;background-color:red"';
                                                                        $myicon = '<i class="icon-close-circle-outline"></i>';
                                                                        $tahap = 1;
                                                                        $statusna = false;
                                                                    } else if ($user->ststahap2 == '0') {
                                                                        $gaya2 = 'style="text-align: center;background-color:#03A9F4"';
                                                                        $myicon = '<i class="icon icon-timer-sand"></i>';
                                                                        $tahap = 1;
                                                                        $statusna = false;
                                                                    } else {
                                                                        $gaya2 = 'style="text-align: center;background-color:white"';
                                                                        $myicon = '<i class=""></i>';
                                                                        $tahap = 1;
                                                                        $statusna = false;
                                                                    }
                                                                    ?>
                                                                    <td <?php echo $gaya2 ?>>
                                                                        <font color="white"><?php if (!is_null($user->tgl_aju_verif_th2)) {
                                                                                                echo $myicon . ' ' . date("d-m-Y", strtotime($user->tgl_aju_verif_th2));
                                                                                            } ?><br><sup style="font-size: 10px"><?php if (!is_null($user->tgl_aju_verif_th2)) {
                                                                                                                                                                                                                                                        echo date("H:i:s", strtotime($user->tgl_aju_verif_th2));
                                                                                                                                                                                                                                                    } ?></sup>
                                                                    </td>
                                                                    <?php if ($user->ststahap3 == '1') {
                                                                        $gaya3 = 'style="text-align: center;background-color:forestgreen"';
                                                                        $myicon = '<i class="icon icon-check-circle-outline"></i>';
                                                                        $tahap = 3;
                                                                        $statusna = true;
                                                                    } else if ($user->ststahap3 == '2') {
                                                                        $gaya3 = 'style="text-align: center;background-color:darkorange"';
                                                                        $myicon = '<i class="icon icon-triangle-outline"></i>';
                                                                        $tahap = 2;
                                                                        $statusna = false;
                                                                    } else if ($user->ststahap3 == '3') {
                                                                        $gaya3 = 'style="text-align: center;background-color:red"';
                                                                        $myicon = '<i class="icon-close-circle-outline"></i>';
                                                                        $tahap = 2;
                                                                        $statusna = false;
                                                                    } else if ($user->ststahap3 == '0') {
                                                                        $gaya3 = 'style="text-align: center;background-color:#03A9F4"';
                                                                        $myicon = '<i class="icon icon-timer-sand"></i>';
                                                                        $tahap = 2;
                                                                        $statusna = false;
                                                                    } else {
                                                                        $gaya3 = 'style="text-align: center;background-color:white"';
                                                                        $myicon = '<i class=""></i>';
                                                                        $tahap = 2;
                                                                        $statusna = false;
                                                                    }
                                                                    ?>
                                                                    <td <?php echo $gaya3 ?>>
                                                                        <font color="white"><?php if (!is_null($user->tgl_aju_verif_th3)) {
                                                                                                echo $myicon . ' ' . date("d-m-Y", strtotime($user->tgl_aju_verif_th3));
                                                                                            } ?><br><sup style="font-size: 10px"><?php if (!is_null($user->tgl_aju_verif_th3)) {
                                                                                                                                                                                                                                                        echo date("H:i:s", strtotime($user->tgl_aju_verif_th3));
                                                                                                                                                                                                                                                    } ?></sup>
                                                                    </td>
                                                                    <?php if ($user->ststahap4 == '1') {
                                                                        $gaya4 = 'style="text-align: center;background-color:forestgreen"';
                                                                        $myicon = '<i class="icon icon-check-circle-outline"></i>';
                                                                        $tahap = 4;
                                                                        $statusna = true;
                                                                    } else if ($user->ststahap4 == '0') {
                                                                        $gaya4 = 'style="text-align: center;background-color:#03A9F4"';
                                                                        $myicon = '<i class="icon icon-timer-sand"></i>';
                                                                        $tahap = 3;
                                                                        $statusna = false;
                                                                    } else {
                                                                        $gaya4 = 'style="text-align: center;background-color:white"';
                                                                        $myicon = '<i class=""></i>';
                                                                        $tahap = 3;
                                                                        $statusna = false;
                                                                    }
                                                                    ?>
                                                                    <td <?php echo $gaya4 ?>>
                                                                        <font color="white"><?php echo $myicon; ?>
                                                                    </td>
                                                                    <?php if ($statusna and $tahap = 3) {
                                                                        $gaya = 'style="text-align: center;background-color:forestgreen"';
                                                                        $tahapan = $tahap;
                                                                    } else if ($statusna and $tahap = 2) {
                                                                        $gaya = 'style="text-align: center;background-color:forestgreen"';
                                                                        $tahapan = $tahap;
                                                                    } else if ($statusna and $tahap = 1) {
                                                                        $gaya = 'style="text-align: center;background-color:forestgreen"';
                                                                        $tahapan = $tahap;
                                                                    } else {
                                                                        $tahapan = $tahap - 1;
