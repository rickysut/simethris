        ...
        <div class="content container">
			<div class="row">
				<div id="notampil" style="display: none;">
					...
					<?php 
					$query = $this->db->get_where('users',array('id_users'=>$user->id_users));
					foreach ($query->result() as $value) {
						$nama_lo = $value->name;
						$namaPers = $value->nama_perusahaan;
					}
					$query2 = $this->db->get_where('cpcl',array('id_cpcl'=>$user->id_cpcl));
					foreach ($query2->result() as $value2) {
						$idriph = $value2->id_mst_riph;
						$noPKS = $value2->no_pks;
					}
					$query3 = $this->db->get_where('mst_riph',array('id_mst_riph'=>$idriph));
					foreach ($query3->result() as $value3) {
						$noRIPH = $value3->nomor_riph;
					}
					?>
				</div>
				<div class="col-12">
                    <div class="card">
						<div class="card-header">
							<div class="description">
								<div class="description-text">
									<h5>DATA PRODUKSI - NO PKS : <?php echo $noPKS ?></h5>
								</div>
							</div>
						</div>
						...
						<div class="card-body">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<?php echo form_input($jml_produksi, $user->jml_produksi) ?>
						...
						<div class="card-body">
							<div class="gallery">
											<ul>
												...
												<li>
													<img width="200" height="125" src="<?php echo base_url('uploads/produksi/'.$file['file_data']); ?>" alt="" >
				...
				<div class="col-12">
                    <div class="card">
						<div class="card-header">
							<div class="description">
								<div class="description-text">
									<h5>PETA - ID REALISASI : <?php echo $user->id_realisasi ?> </h5>
								</div>
							</div>
						</div>
...
<!--script google map
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&key=AIzaSyCmByxQYKyC_hhkkoSFCiWM_0TwQjGckLs"></script>
-->
<script>
        $(document).ready(function(){
	...
	<div class="modal fade" id="verifikasiModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<?php echo form_input($id_users,$user->id_users) ?>
				<?php echo form_input($company_id, $companyid) ?>
				<?php echo form_input($on_year, $period_year) ?>
				<?php echo form_input($id_produksi,$user->id_produksi) ?>
