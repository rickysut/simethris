<?php $this->load->view('back/template/meta'); ?>
  ...
  <div class="doc forms-doc page-layout simple full-width">
	...
	<div class="page-content p-3">
		...
		<?php echo form_hidden('id_riph',  $user->id_riph);?>
						...
						<div class="card-header">
							<div class="description">
								<div class="description-text">
									<h5>UPDATE DATA RIPH <?php echo $user->id_riph ?> </h5>
								</div>
							</div>
						</div>
						<div class="card-body">
							<div class="form-row">
								<div class="form-group col-md-4">
									<label class="col-form-label">Periode tahun RIPH </label>
								</div>
								<div class="form-group col-md-4">
									<?php echo form_input($periode, $user->periode) ?>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-4">
								...
								<div class="form-group col-md-4">
									<?php echo form_input($tanggal, (new DateTime($user->tanggal))->format('Y-m-d\TH:i:s') )?>
								</div>
							</div>
