								...
								<table id="dataTable" class="table table-bordered table-striped">
								  ...
								  <tbody>
									<?php $no = 1; foreach($get_all_riph as $user){
									  // status active
									  $edit = '<a href="'.base_url('riphadmin/update/'.$user->id_riph).'" data-toggle="tooltip" title="Edit Data RIPH" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></a>';
									  $delete = '<a href="'.base_url('riphadmin/delete/'.$user->id_riph).'" data-toggle="tooltip" title="Hapus Data RIPH" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>';
									?>
									
									  <tr>
										<td style="text-align: center"><?php echo $no++ ?></td>
										<td style="text-align: left"><?php echo $user->periode ?></td>
