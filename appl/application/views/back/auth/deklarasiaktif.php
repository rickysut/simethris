      ...
      <p class="login-box-msg">Terima Kasih Sudah Bergabung Dengan simeTHRIS</p>
        <div class="row">
          <div class="alert alert-info alert-dismissible" align="center">
								...
								<h4><i class="icon fa fa-ban"></i>AKUN BERHASIL DIAKTIVASI</h4>
								<P>Anda Sudah Berhasil mengaktifkan akun simeTHRIS. Silahkan Login untuk melanjutkan</p>
							  </div>
        </div>
   
	  <div class="d-flex">
		
			<div align="center" class="px-4">Terima kasih, <b>GEDOR HORTI</B> </div>
