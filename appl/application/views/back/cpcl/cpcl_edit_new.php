						...
						<div class="card-header">
							<div class="row no-gutters align-items-center justify-content-between">
								...
								<div class="btn-group" role="group" aria-label="saprodi">
										<a class="btn btn-primary fuse-ripple-ready" href="#" id="tombolTambahSaprodi" title="Isi / Tambah Saprodi" onclick="add_saprodi()"><i class="icon-account-plus"></i> Tambah Saprodi</a>
                    ...
                    <div class="card">
						<div class="card-header">
							...
							<div class="btn-group" role="group" aria-label="daftar-petani">
									<a class="btn btn-primary fuse-ripple-ready" href="#" id="tombolTambahpetani" title="Isi / Tambah" onclick="add_person()"><i class="icon-account-plus"></i> Tambah Data / Petak</a>
...
<script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC1ea90fk4RXPswzkOJzd17W3EZx_KNB1M&callback=initMap&v=weekly"
      async
></script>