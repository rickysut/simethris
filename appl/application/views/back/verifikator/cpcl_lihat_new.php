						...
						<div class="card-header bg-1">
							<div class="description">
								<div class="description-text">
									<h5 class="text-white">DATA PELAKSANA</h5>
								</div>
							</div>
						</div>
						<div class="card-body">
								...
								<table>
									<thead>
										<tr>
											...
											<th style="width: 20%;">Hasil Verifikasi</th>
											<th style="width: 20%;">Catatan Pemeriksaan</th>
									...
									<tbody>
										<tr>
											<td>Nomor PKS</td>
											<td style="text-align: center;"><?php echo form_input($no_pks,$user->no_pks) ?></td>
											<td><input class="form-control" type="text" placeholder="no. PKS"></td>
											<td>
										...
										<tr>
											<td>Pola Kerja</td>
											<td style="text-align: center;" disabled><?php echo form_dropdown('', $type_pelaksana_value, $user->type_pelaksana, $type_pelaksana) ?></td>
											<td>
												<select class="form-control" type="text">
													<option hidden>pilih pola kerja</option>
										...
										<tr>
											<td>Kelompok Tani</td>
											<td style="text-align: center;" disabled><?php echo form_input($nama_pelaksana,$user->nama_pelaksana) ?></td>
											<td>
												<input type="text" class="form-control" id="" aria-describedby="">
											</td>
											<td>
										...
										<tr>
											<td>Tanggal Rencana Tanam</td>
											<td style="text-align: center;" disabled><?php echo form_input($tgl_rencana_tanam,$user->tgl_rencana_tanam) ?></td>
											<td>
												<input type="text" class="form-control" id="" aria-describedby="">
											</td>
											<td>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header bg-1">
							<div class="description">
								<div class="description-text">
									<h5 class="text-white">DATA LOKASI</h5>
								</div>
							</div>
						</div>
						<div class="card-body">
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td><input class="form-control" type="text" placeholder="Provinsi"></td>
											<td>
												<input type="text" class="form-control" id="" aria-describedby="">
											</td>
											<td>
										...
										<tr>
											...
											<td><input class="form-control" type="text" placeholder="Kabupaten"></td>
											<td>
												<input type="text" class="form-control" id="" aria-describedby="">
											</td>
											<td>
										...
										<tr>
											...
											<td><input class="form-control" type="text" placeholder="Kecamatan"></td>
											<td>
												<input type="text" class="form-control" id="" aria-describedby="">
											</td>
											<td>
										...
										<tr>
											...
											<td><input class="form-control" type="text" placeholder="Desa"></td>
											<td>
												<input type="text" class="form-control" id="" aria-describedby="">
											</td>
											<td>
				...
				<div class="col-12">
						<div class="card">
							<div class="card-header bg-1">
								<div class="description">
									<div class="description-text">
										<h5 class="text-white">PEMETAAN</h5>
									</div>
								</div>
							</div>
							<div class="card-body">
