								...
								<table id="dataTable" class="table table-bordered table-striped">
								  ...
								  <tbody>
									<?php $no = 1; foreach($get_all_riph as $user){
									  ...
									  $delete = '<a href="'.base_url('riph/delete/'.$user->id_riph).'" data-toggle="tooltip" title="Hapus Data RIPH" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger btn-sm"><i class="icon-delete-outline"></i></a>';
									?>
