                    ...
                    <div class="card">
						...
						<div class="card-body">
							...
							<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									...
									<div class="custom-file" >
										<input type="file" name="file_logbook" id="file_logbook" class="form-control" onchange="photoPreview(this,'f5preview', 'labelf5')"/>
										<label id='labelf5' class="custom-file-label" for="file_logbook">Ganti surat pernyataan kesangggupan (Form-5)</label>
									</div>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label>current File laporan akhir</label>

									<?php if ($user->file_lakhir){ 
									
										if(pathinfo($user->file_lakhir, PATHINFO_EXTENSION)=='pdf'){
											$pregmb = '<a href="#"><img src="'.base_url('/assets/images/pdf_thumb.png').'" height="75" onClick="ViewAttachmentPdf('."'".base_url('/uploads/file_lakhir/'.$user->file_lakhir)."'".','."'".pathinfo(base_url('/uploads/file_lakhir/'.$user->file_lakhir),PATHINFO_FILENAME)."'".');" alt="current File laporan akhir"></a>';
										}else if(pathinfo($user->file_lakhir, PATHINFO_EXTENSION)=='docx'){
											$pregmb = '<a href="'.base_url('/uploads/file_lakhir/'.$user->file_lakhir).'"><img width="75px" src="'.base_url('/assets/images/docx_thumb.png').'"></a>';
										}else if(pathinfo($user->file_lakhir, PATHINFO_EXTENSION)=='xlsx'){
											$pregmb = '<a href="'.base_url('/uploads/file_lakhir/'.$user->file_lakhir).'"><img width="75px" src="'.base_url('/assets/images/excel_thumb.png').'"></a>';
										}else{
											$pregmb = '<a href="#"><img src="'.base_url('/uploads/file_lakhir/'.$user->file_lakhir).'" height="75" onClick="ViewAttachmentImage('."'".base_url('/uploads/file_lakhir/'.$user->file_lakhir)."'".','."'".pathinfo(base_url('/uploads/file_lakhir/'.$user->file_lakhir),PATHINFO_FILENAME)."'".');" alt="current File laporan akhir"></a>';
										}
									}?>
									<p><?php echo $pregmb;?></p>
									<label><?php $user->file_lakhir ?></label>
								</div>
								<div class="form-group col-md-6">
									<label>current File laporan akhir</label>
									<?php if ($user->file_logbook){  
										if(pathinfo($user->file_logbook, PATHINFO_EXTENSION)=='pdf'){
											$pregmb = '<a href="#"><img src="'.base_url('/assets/images/pdf_thumb.png').'" height="75" onClick="ViewAttachmentPdf('."'".base_url('/uploads/file_logbook/'.$user->file_logbook)."'".','."'".pathinfo(base_url('/uploads/file_logbook/'.$user->file_logbook),PATHINFO_FILENAME)."'".');" alt="current File logbook"></a>';
										}else if(pathinfo($user->file_logbook, PATHINFO_EXTENSION)=='docx'){
											$pregmb = '<a href="'.base_url('/uploads/file_logbook/'.$user->file_logbook).'"><img width="75px" src="'.base_url('/assets/images/docx_thumb.png').'"></a>';
										}else if(pathinfo($user->file_logbook, PATHINFO_EXTENSION)=='xlsx'){
											$pregmb = '<a href="'.base_url('/uploads/file_logbook/'.$user->file_logbook).'"><img width="75px" src="'.base_url('/assets/images/excel_thumb.png').'"></a>';
										}else{
										  $pregmb = '<a href="#"><img src="'.base_url('/uploads/file_logbook/'.$user->file_logbook).'" height="75" onClick="ViewAttachmentImage('."'".base_url('/uploads/file_logbook/'.$user->file_logbook)."'".','."'".pathinfo(base_url('/uploads/file_logbook/'.$user->file_logbook),PATHINFO_FILENAME)."'".');" alt="current File logbook"></a>';
										}
									}?>
									<p><?php echo $pregmb;?></p>
									<label><?php $user->file_logbook ?></label>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
									<div >
										<img id="lapreview" src="<?php echo base_url('/assets/images/pdf_thumb.png') ?>" width="auto" height="150px"/>
									</div>	
									<div class="custom-file" >
										<input type="file" name="file_lakhir" id="file_lakhir"  class="form-control" onchange="photoPreview(this,'lapreview', 'file_lakhir')"/>
										<label id="file_lakhir" class="custom-file-label" for="file_lakhir">Laporan Akhir</label>
									</div>
									
								</div>
								<div class="form-group col-md-6">
									<div >
										<img id="lbpreview" src="<?php echo base_url('/assets/images/pdf_thumb.png') ?>" width="auto" height="150px"/>
									</div>
									<div class="custom-file" >
										<input type="file" name="file_logbook" id="file_logbook" class="form-control" onchange="photoPreview(this,'lbpreview', 'file_logbook')"/>
										<label id='file_logbook' class="custom-file-label" for="file_logbook">Log Book</label>
									</div>
							...
							<div class="form-row">
								<div class="form-group col-md-12">
									<label>current File SPTJM</label>
									<?php if ($user->file_sptjm) {
										if(pathinfo($user->file_sptjm, PATHINFO_EXTENSION)=='pdf'){
										  $pregmb = '<a href="#"><img src="'.base_url('/assets/images/pdf_thumb.png').'" height="75" onClick="ViewAttachmentPdf('."'".base_url('/uploads/file_sptjm/'.$user->file_sptjm)."'".','."'".pathinfo(base_url('/uploads/file_sptjm/'.$user->file_sptjm),PATHINFO_FILENAME)."'".');" alt="current File SPTJM"></a>';
									  	}else if(pathinfo($user->file_sptjm, PATHINFO_EXTENSION)=='docx'){
										  $pregmb = '<a href="'.base_url('/uploads/file_sptjm/'.$user->file_sptjm).'"><img width="75px" src="'.base_url('/assets/images/docx_thumb.png').'"></a>';
									  	}else if(pathinfo($user->file_sptjm, PATHINFO_EXTENSION)=='xlsx'){
										  $pregmb = '<a href="'.base_url('/uploads/file_sptjm/'.$user->file_sptjm).'"><img width="75px" src="'.base_url('/assets/images/excel_thumb.png').'"></a>';
										}else{
										  $pregmb = '<a href="#"><img src="'.base_url('/uploads/file_sptjm/'.$user->file_sptjm).'" height="75" onClick="ViewAttachmentImage('."'".base_url('/uploads/file_sptjm/'.$user->file_sptjm)."'".','."'".pathinfo(base_url('/uploads/file_sptjm/'.$user->file_sptjm),PATHINFO_FILENAME)."'".');" alt="current File SPTJM"></a>';
										}
									}?>
									<p><?php echo $pregmb;?></p>
									<label><?php echo $user->file_sptjm ?></label>
								</div>
								<div class="form-group col-md-6">
									<div >
										<img id="sptjmreview" src="<?php echo base_url('/assets/images/pdf_thumb.png') ?>" width="auto" height="150px"/>
									</div>
									<div class="custom-file" >
										<input type="file" name="file_sptjm" id="file_sptjm" class="form-control" onchange="photoPreview(this,'sptjmreview', 'file_sptjm')"/>
										<label id='file_sptjm' class="custom-file-label" for="file_sptjm">Form SPTJM Surat Pertanggungjawaban Mutlak</label>
									</div>
						...
						<div class="card-footer">
							<div class="btn-group" role="group" aria-label="Default button group">
									<button class="btn btn-primary" type="submit"><i class="icon-content-save"></i> <?php echo $btn_submit2 ?></button>
