				...
				<div class="box box-primary">
				  ...
				  <div class="box-body">
					...
					<div class="form-group"><label>Lampiran</label>
						<p><img src="<?php echo base_url('uploads/user/'.$user->lampiran_thumb) ?>" width="200px" alt="current photo"></p>
					  <input type="file" name="lampiran" id="lampiran" class="form-control" onchange="photoPreview(this,'preview')"/>
...
<!--script google map-->
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true?key=AIzaSyDaMs21-YdoTeAAuxFInk6F4lks9t8TRRs"></script>
<script>
