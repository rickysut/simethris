     ...
     <div class="row">          
            ...
            <div class="col-md-4">
              ...
              <div class="box box-danger">
                ...
                <!-- /.box-header -->
                <div class="box-body no-padding daftaruser">
					<ul class="nav nav-stacked">
						
                    <?php if(!empty($vendorslist)){
						foreach($vendorslist as $v):
						?>
                      <li class="selectVendor" id="<?=$v['id_users'];?>" title="<?=$v['name'];?>"><a class="users-list-name" href="#"><img class="user-image" src="<?=$v['photo'];?>" alt="<?=$v['name'];?>" title="<?=$v['name'];?>" width="50" height="50">  <?=$v['name'];?></a></li>
