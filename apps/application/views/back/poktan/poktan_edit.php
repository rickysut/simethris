...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard') ?>"><i class="fa fa-dashboard"></i> Poktan</a></li>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group"><label>Nama Kelompok Tani (*)</label>
                  <?php echo form_input($nama_poktan, $user->nama_poktan, $user->nama_poktan) ?>
                </div>
              </div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group"><label>Jumlah Anggota (*)</label>
						<?php echo form_input($jml_anggota, $user->jml_anggota, $user->jml_anggota) ?>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group"><label>Luas Lahan (*)</label>
						<?php echo form_input($luas_lahan, $user->luas_lahan, $user->luas_lahan) ?>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group"><label>Latitude</label>
						<?php echo form_input($atitude, $user->atitude, $user->atitude) ?>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group"><label>Longitude</label>
						<?php echo form_input($latitude, $user->latitude, $user->latitude) ?>
					</div>
				</div>
