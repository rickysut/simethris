					...
					<div class="row">
					  ...
					  <div class="col-sm-6">
						<div class="form-group"><label>ID Verifikasi</label>
							<?php echo form_input($id_verifikasi_2,$user->id_r_jverifikasi) ?>
						</div>
					  </div>
					  <div class="col-sm-6">
						<div class="form-group" ><label>Status Verifikasi</label>
							<?php echo form_dropdown('', $is_verifikasi_2_value, '', $is_verifikasi_2) ?>
						</div>
					  </div>
					 </div>
					  <div class="row">
					  <div class="col-sm-6">
						<div class="form-group"><label>Keterangan</label>
							<?php echo form_textarea($keterangan_2) ?>
						</div>
					  </div>
					  <div class="col-sm-6">
						<div class="form-group"><label>Unggah Bukti *</label>
							  <input type="file" name="bukti2" id="bukti2" class="form-control"/>
