...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard') ?>"><i class="fa fa-dashboard"></i> List Produksi</a></li>
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all_produksi as $user){
                  // status active
                   // action
                ...
                ?>
                  <tr>
                    ...
                    <td style="text-align: left"><?php echo $user->tgl_produksi ?></td>
					...
					<td style="text-align: right"><?php echo $user->jml_produksi ?></td>
