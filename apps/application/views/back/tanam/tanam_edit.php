				  ...
				  <div class="box-body">
					<div class="row">
					  <div class="col-sm-6">
						...
						<?php echo form_dropdown('', $id_pelaksana_value, $user->id_pelaksana, $id_pelaksana) ?>
						</div>
					  </div>
					  <div class="col-sm-6">
						<div class="form-group"><label>Rencana Luas Tanam</label>
						  <?php echo form_input($renc_luas_tanam,$user->renc_luas_tanam) ?>
						</div>
					  </div>
					</div>
					<div class="row">
					  <div class="col-sm-6">
						<div class="form-group"><label>Rencana Tanggal Tanam</label>
						  <?php echo form_input($renc_tgl_tanam,$user->renc_tgl_tanam) ?>
						</div>
					  </div>
					  <div class="col-sm-6">
				  ...
				  <div class="box-body">
					<div class="row">
					  <div class="col-sm-6">
						...
						<?php echo form_input($id_petak,$user->id_petak) ?>
						</div>
					  </div>
					  <div class="col-sm-6">
