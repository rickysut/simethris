...
class Realisasi extends CI_Controller{
  ...
  public function __construct()
  {
    ...
    $this->data['add_action'] = base_url('realisasi/create/'.$this->uri->segment(3));
  ...
  function create_action()
  {
    ...
    else
    {
        ...
        $this->Realisasi_model->insert($data1);
		...
		//redirect(base_url('realisasi/daftarrealisasi/'.$this->uri->segment(3)));
      }
