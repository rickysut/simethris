	...
	<?php 
		function main_menu() {
			$ci = & get_instance();
			$query = $ci->db->query("SELECT id_menu, nama_menu, link, id_parent FROM menuweb where aktif='Ya' AND position='Bottom' order by urutan");
	...
	<?php
	$pilihan = $this->model_utama->view_where('menuweb', array('id_parent' => '0', 'aktif' => 'Ya'));
	foreach ($pilihan->result_array() as $row) {    
    ?>
<li class="dropdown dropdown-mega">
<a href="id/index.html#" class="dropdown-toggle"><?php echo $row['nama_menu']; ?></a>
			...
			<div class="dropdown-mega-content container">
				<div class="row">
					<div class="col-md-3">
						...
						<?php
						$pilihan2 = $this->model_utama->view_where('menuweb', array('id_parent' => $row['id_menu'], 'aktif' => 'Ya'));
						...
						?>
							<div class="col-md-3">
								...
								<?php
								$pilihan3 = $this->model_utama->view_where('menuweb', array('id_parent' => $row2['id_menu'], 'aktif' => 'Ya'));
