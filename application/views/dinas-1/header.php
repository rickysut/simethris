                ...
                <div class="header-column">
                    <div style="text-align: center;"> 
						<?php 
							...
							echo "<img style='width:375px;' src='".base_url()."asset/logo/$row[gambar]'/>";
							}
							?>
						<h5><span style=" color: #fff;"></span></b></h5>
						<h3><span style=" color: #fff;">DIREKTORAT JENDERAL HORTIKULTURA</span></h3>
                    </div>
                </div>
            ...
            <div class="header-nav-main header-nav-main-light header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse" style="padding-top:3px;">
                <nav>
                    <ul class="nav nav-pills" id="mainNav">
						...
						<li><a href="<?php echo base_url();?>appl/">
									LOGIN
								</a></li>
