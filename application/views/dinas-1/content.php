...
<section class="section section-no-background m-none">
	<div class="container">
		...
		<div class="col-md-3" data-wow-delay=".4s">
			<h2 class="mb-lg">DOWNLOAD</h2>
				<?php
					$no = 1; 
					$pengumuman = $this->model_app->view_ordering_limit('download','id_download','DESC',0,5);
					foreach ($pengumuman->result_array() as $row) {
						if ($row['nama_file']==''){ $file = 'Tidak Ada File yang Di sertakan/lampirkan'; $color = 'red'; $ket = ''; }else{ $file = $row['nama_file']; $color = 'blue'; $ket = 'Download file :'; }
